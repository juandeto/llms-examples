        ...
        messages = [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "You are an AI assistant that validates research articles for accuracy, completeness, and adherence to academic standards. It's important to NOT MODIFICATE the language of the original article."
                    }
                ]
            },
            {
